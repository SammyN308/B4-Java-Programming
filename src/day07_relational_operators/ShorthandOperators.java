...
public class ShorthandOperators {
    public static void main(String[] args) {
        ...
        a++;        // re-assgined by POST INCREMENT (increased value by 1 -- > a = a + 1;
        ...
        a += 10;   // re-assigned by SHORTHAND OPERATOR (increasing it by 10) --> a = a + 10; (same as above)
        System.out.println(a); // a = 43
        // a =+10; //This is not SHORTHAND OPERATOR
        a = 10 + 23; //  a += 23; ---> a = a + 23; --> a = 43 + 23 --- > so NOT THE SAME
